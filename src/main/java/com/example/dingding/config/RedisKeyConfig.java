...
public class RedisKeyConfig {
    //注册验证码 String  有效期10
    //后面追加手机号
    public static final String SMS_RCODE="dingding:sms:rcode:";
    //单位秒
    public static final int RCODE_TIME=600;
    //存储令牌
    public static final String LOGIN_TOKEN="dingding:login:token:";//追加令牌

    public static final String LOGIN_USER="dingding:login:uid:";//追加用户id
