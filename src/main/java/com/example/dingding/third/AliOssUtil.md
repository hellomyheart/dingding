```java
package com.example.dingding.third;

import com.aliyun.oss.OSS;
import com.aliyun.oss.OSSClientBuilder;
import com.aliyun.oss.model.Bucket;
import com.example.dingding.config.SystemConfig;
import com.example.dingding.util.DateUtil;
 ...
 * @package: com.example.dingding.third
 * @author: Stephen Shen
 * @date: 2020/10/30 上午10:09
 */
public class AliOssUtil {
    // Endpoint以杭州为例，其它Region请按实际情况填写。
    private static final String endpoint = "https://aliyuncs.com";
    // 阿里云主账号AccessKey拥有所有API的访问权限，风险很高。强烈建议您创建并使用RAM账号进行API访问或日常运维，请登录RAM控制台创建RAM账号。
    private static final String accessKeyId = "XXXXX";
    private static final String accessKeySecret = "XXXXXX";
    public static final String BucketName = "XXXXXXX";
